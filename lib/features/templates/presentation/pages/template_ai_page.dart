...
/// edición en la misma superficie, sobre el [AiConfigEditor] compartido (stat
/// tiles + sheets por campo, gating por capacidades del catálogo). Cada edición
/// es un PUT con CAS sobre el `TemplateDetailBloc` (re-GET en 409); el name
/// nunca viaja modificado. Content-only: el router monta el Scaffold + AppBar
    ...
    return BlocListener<TemplateDetailBloc, TemplateDetailState>(
      ...
      child: BlocBuilder<TemplateDetailBloc, TemplateDetailState>(
        builder: (context, state) => switch (state) {
          TemplateDetailLoading() => const AppLoadingIndicator(),
        ...
        children: <Widget>[
          AppCard(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                // La caption hace legible que aquí NO hay botón Guardar: cada
                // control persiste al momento (a diferencia de la org).
                  ...
                  builder: (context, catState) {
                    ...
                    return AiConfigEditor(
                      ...
                      onChanged: (next) => context
                          ...
                          .add(TemplateDetailAiUpdateRequested(next)),
          ...
          const SizedBox(height: AppTokens.sp4),
          AppCard(child: TemplatePromptCard(prompt: ai.systemPrompt)),
