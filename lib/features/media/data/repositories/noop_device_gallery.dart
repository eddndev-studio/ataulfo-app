...
/// (escritorio, web): `isSupported()` responde false, así que la UI nunca
/// ofrece el destino Galería. Si algo lo consulta igual, responde vacío/null
/// (como un carrete sin media) en vez de lanzar.
