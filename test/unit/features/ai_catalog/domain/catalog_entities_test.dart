...
void main() {
  group('AIModel', () {
    test('value equality compara id + supportsTemperature + supportsThinking', () {
  ...
  group('ProviderEntry', () {
    test('value equality compara provider + defaultModel + lista de models', () {
    ...
    test('provider es String crudo (no enum) — el backend es la fuente canónica',
        () {
